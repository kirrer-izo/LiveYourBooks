...
class GeminiAIService
{
     ...
     */
    public function generateBookResponse(string $message, ?int $bookId = null, ?int $conversationId = null, ?User $user = null): array
    {
        $user = $user ?? Auth::user();
        if (!$user) {
        ...
        // Include book context in the message if available
        $fullMessage = $message . $bookContext;
